@@ -0,0 +1,219 @@
 ...
 <body>
     <header class="container text-center">
         <img src="img/avatar-perfil.png" alt="avatar da elison" class="rounded-circle" width="150" height="150"
             srcset="">
         <p class="lead">Eu sou elison_</p>
         <h1>Eu estudo no colegio estadual nestol de castro</h1>
         <p>Suo um moeque que inisiei um curso de espanhol e mecanica de eletro domestico</p>
         <p>Minhas habilidades</p>
         <div>
             <p class="badge bg-secondary">Andar de cavalo </p>
             <p class="badge bg-secondary">crial umas coisas mada afer</p>
